...
public class BroadcastMessage extends ImagedTextMessage {
    ...
    public BroadcastMessage(String message, List<Integer> users, @Nullable File image, @Nullable Keyboard keyboard) {
        super(message, keyboard, image);
        this.users = users;
    }

    public BroadcastMessage(String message, List<Integer> users, @Nullable File image) {
